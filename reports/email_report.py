...
MARKET_GLOSSARY = [
    ...
    ("gold trend", "Gold's 1-month direction. A sharp RISE = investors hiding in safe-havens (fearful, can pressure stocks); a FALL = risk appetite returning (supportive for stocks)."),
